...
GO
PRINT N'Altering Procedure [dbo].[medie]...';


GO
ALTER PROCEDURE [dbo].[medie]
AS
	SELECT Table1.Name , CONVERT(DOUBLE PRECISION,SUM((Table2.not1+Table2.not2+Table2.not3+Table2.not4+Table2.not5)/5.0)) AS medie FROM Table1
		JOIN Table2 ON Table2.Id = Table1.Id
	GROUP BY Table1.Id, Table1.Name ORDER BY medie;
RETURN 0
GO
