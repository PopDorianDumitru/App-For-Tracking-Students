...
AS
	SELECT Table1.Name AS Nume ,SUM((Table2.not1+Table2.not2+Table2.not3+Table2.not4+Table2.not5)/5.0) AS medie FROM Table2
		JOIN Table1 ON Table2.student_id = Table1.Id
	GROUP BY student_id;
RETURN 0
GO
